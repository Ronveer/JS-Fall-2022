...
Sat Recitation: We need a very good understanding of strings and index search for advanced programming 
Reviewing operators 
...
If you WANT TO replace old value with UPPERCASE 

myCity = myCity.toUppercase();
console.log(`\nmyCity`) -> ${myCity}\n`);

to cpnvert String into lowercase 
...
String fx
To find if the String starts exact given pattern:
function: startsWith();
input: 1 string
return type: boolean
...
let myCityStartWith_hello_de = myCity.startsWith('hello de');
